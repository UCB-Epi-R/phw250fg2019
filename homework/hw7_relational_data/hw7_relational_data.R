...
# Homework 7: Relational data
#####################################
# Don't change these lines, just run them!
# Load okR autograder
tryCatch({source('setup/autograder-setup/hw7_relational_data/hw7_relational_data.ok.R')},
...
# cd; cd phw250fg2019/homework/hw7_relational_data; python3 ok --submit;
